...
var Exchange = function(exchangeInfo) {
	...
	var exchange = {
		myName : userItem != undefined ? userItem.name : "",
		myDesc : userItem != undefined ? userItem.description : "",
		myItemImg : userItem != undefined ? userItem.firstItemCenterImgUrl : "",
		targetDesc : targetItem != undefined ? targetItem.description : "",
		targetItemImg : targetItem != undefined ? targetItem.firstItemCenterImgUrl
				: "",
		targetHeadImg : target != undefined ? target.headImgUrl : "",
		targetNickname : target != undefined ? target.nickname : "",
